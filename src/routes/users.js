...
router.get('/liquidacion/usuarios', async (req, res) => {
  try {
    ...
    const result = await pool.request().query(`SELECT TOP (100) RunCuerpo, RunDigito, Nombres, ApellidoPaterno, ApellidoMaterno, Email FROM [Castellano].[dbo].[Persona]`);  // Ejecutar consulta SQL
